...
REGION_PROFILES: dict[str, RegionProfile] = {
    "se": RegionProfile(
        ...
        locale="sv",
        ui_locale="sv",
        auth_index_values=("GlobalLogin", "SeB2COGWLogin"),
    ...
    "fi": RegionProfile(
        ...
        locale="fi",
        ui_locale="fi",
        auth_index_values=("GlobalLogin", "FIB2CLogin", "SeB2COGWLogin"),
        callback_page_path="",
        referer_path="",
    ...
    "no": RegionProfile(
        ...
        locale="no",
        ui_locale="nb",
        auth_index_values=("GlobalLogin", "NOB2COGWLogin", "SeB2COGWLogin"),
